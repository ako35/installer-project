...
const CustomerFormPage = () => {
  ...
  "Çorum": ["Alaca", "Bayat", "Boğazkale", "Dodurga", "İskilip", "Kargı", "Mecitözü", "Merkez", "Oğuzlar", "Ortaköy", "Osmancık", "Sungurlu", "Uğurludağ"],
  ...
  "Eskişehir": ["Alpu", "Beylikova", "Çifteler", "Günyüzü", "Han", "İnönü", "Mahmudiye", "Mihalıççık", "Mihalgazi", "Odunpazarı", "Sarıcakaya", "Seyitgazi", "Sivrihisar", "Tepebaşı"],
  ...
  "Kastamonu": ["Abana", "Ağlı", "Araç", "Azdavay", "Bozkurt", "Cide", "Çatalzeytin", "Daday", "Devrekani", "İhsangazi", "İnebolu", "Küre", "Merkez", "Pınarbaşı", "Seydiler", "Şenpazar", "Taşköprü", "Tosya"],
  ...
  "Şanlıurfa": ["Akçakale", "Birecik", "Bozova", "Ceylanpınar", "Halfeti", "Haliliye", "Harran", "Hilvan", "Karaköprü", "Siverek", "Suruç", "Viranşehir"],
  "Şırnak": ["Beytüşşebap", "Cizre", "Güçlükonak", "İdil", "Merkez", "Silopi", "Uludere"],
  "Tekirdağ": ["Çerkezköy", "Çorlu", "Ergene", "Hayrabolu", "Kapaklı", "Malkara", "Merkez", "Muratlı", "Saray", "Şarköy"],
  ...
  "Zonguldak": ["Alaplı", "Çaycuma", "Devrek", "Ereğli", "Gökçebey", "Kilimli", "Merkez"],
  };
  ...
  <table>
    <tbody>
      <tr>
        ...
        <td>
          <div className="form-group p-2">
            <label>Kurulumcu:</label>
            <select name="installerCustomer" value={formData.installerCustomer} onChange={handleChange} required>
              <option value="" disabled>Kurulumcu Seçin:</option>
              {installers.filter(installer => installer.role === "installer").map((installer) => (
                <option key={installer._id} value={installer._id}>{installer.username}</option>
              ))}
            </select>
          </div>
        </td>
